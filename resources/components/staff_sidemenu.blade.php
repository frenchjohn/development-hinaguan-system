        ...
        <ul class="list-none m-0 p-0 flex flex-col gap-[2px] h-full justify-between">
            @foreach ($links as $index => $link)
                <li>
                    ...
                    >
                        <span class="nav-icon relative w-6 h-6 flex items-center justify-center mb-0.5 shrink-0 rounded-lg bg-transparent transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] opacity-85 group-hover/link:opacity-100 group-hover/link:scale-110">
