                ...
                <div class="grid grid-cols-1 gap-6 xl:grid-cols-2">
                    ...
                    <section class="dash-panel flex flex-col rounded-2xl border border-glass-border bg-glass p-6 shadow-glass">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                            ...
                            <a href="{{ route('admin.announcements') }}" class="flex items-center gap-2.5 rounded-xl border border-glass-border p-3 text-xs font-semibold text-hp-text no-underline transition-all hover:bg-glass-hover hover:border-hp-green-mid">
                            ...
                            <a href="{{ route('admin.feedback') }}" class="flex items-center gap-2.5 rounded-xl border border-glass-border p-3 text-xs font-semibold text-hp-text no-underline transition-all hover:bg-glass-hover hover:border-hp-green-mid">
                                <svg class="h-4 w-4 text-hp-green-mid" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"/></svg>
                                Feedback
                            </a>
